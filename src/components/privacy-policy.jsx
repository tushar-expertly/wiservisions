    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            At Wiservisions, we are dedicated to safeguarding your privacy and
            ...
            Wiservisions. This Privacy Policy also outlines our data storage
          ...
          <p className="mb-4">
            At Wiservisions, we will only request personal information when it
            is necessary to identify you or to facilitate contact with you. This
          ...
          <p className="mb-4">
            In the event that Wiservisions invites you to complete and submit an
          ...
          <p className="mb-4">
            It's important to note that while Wiservisions may track a visitor's
          ...
          <p className="mb-4">
            The purposes for which Wiservisions may utilize your personal
          ...
          <p className="mb-4">
            If you wish to be removed from any Wiservisions distribution list,
          ...
          <p className="mb-4">
            ...
            Wiservisions, you may receive telephone calls from us regarding new
          ...
          <p className="mb-4">
            The Wiservisions website may contain links to external websites,
            ...
            are not governed by Wiservisions's privacy policy. Wiservisions has
            no control over the content or information gathering practices of
            these external sites.
          </p>
          <p className="mb-4">
            Please note that this Privacy Policy specifically pertains to
            Wiservisions's privacy practices and does not extend to the privacy
            policies or practices of third-party websites or features.
            Wiservisions cannot be held responsible for the privacy policies
          ...
          <p className="mb-4">
            ...
            paramount at Wiservisions. We have implemented robust measures to
          ...
          <p className="mb-4">
            At Wiservisions, we remain committed to upholding the highest
          ...
          <p className="mb-4">
            ...
            Wiservisions remains fully compliant with the EU-US Privacy Shield
          ...
          <p className="mb-4">
            At Wiservisions, we are committed to maintaining the highest
          ...
          <p className="mb-4">
            Wiservisions is mandated to adhere to specific procedures when
          ...
          <p className="mb-4">
            In accordance with the Privacy Shield Principles, Wiservisions is
          ...
          <p className="mb-4">
            Wiservisions is subject to the investigative and enforcement
          ...
          <p className="mb-4">
            Wiservisions reserves the right to modify or supplement this Privacy
            Policy at its discretion. We encourage you to periodically review
            this section of Wiservisions’s website to stay informed of any
