...
function Header() {
  ...
  return (
    <header className="border-b bg-amber-100  min-h-[60px] px-10 py-3 relative tracking-wide relative z-50">
        ...
        >
          ...
          {user ? (
            ...
            <>
              <Link
                to="/login"
                className="px-3 py-2 text-sm rounded-full font-bold text-white border-2  bg-blue-700	 transition-all ease-in-out duration-300 hover:bg-orange-300 hover:text-[#007bff]"
              >
                Login
              </Link>
              <Link
